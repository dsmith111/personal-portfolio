...
export default function AboutBody({ styles, width }) {
  const IMAGES = [
    {
      ...
      thumbnailHeight: 250,
      caption:
        "Group photo after the conclusion of the TEDx event I organized Sophomore-Junior year of college.",
    },
    {
    ...
    >
      <div className="col-5 offset-1" style={{ marginTop: 135, height: 600 }}>
        ...
        <div style={{ fontSize: 18 }}>
          ...
          <p>
            Previously, I have worked as a material researcher for the Polymer
            and Inorganic Composites, Structures and Surfaces Lab at the
            University of Toledo (PICCSL), an Industrial Engineer at Ford, GM,
            and Chrysler-Toledo as well as a Software Engineer at
            Chrysler-Warren.
          </p>
          <p>
            I completed my undergraduate studies at the University of Toledo
            earning a Bachelor's of Science in Mechanical Engineering with
            minors in physics and mathematics. During my undergraduate program
            my research at PICCSL led to a publication and pending patent, I
            contributed to a chemical engineering textbook used by ZyBooks (a
            Wiley subsidary), and I organized and led a TEDx event, taking in
            speakers from NASA, Fermi Lab and more.
          </p>
        </div>
      </div>
