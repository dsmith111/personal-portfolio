      ...
      >
        ...
        <Card style={styles.cardWrap} elevation={4}>
          ...
          <CardContent style={styles.cardDesc}>
            <p className="card-title">Experimental Heat Exchanger Testing Device</p>
        ...
        <Card style={styles.cardWrap} elevation={4}>
          ...
          />
          <CardContent style={styles.cardDesc}>
            <p className="card-title">Eco/Evolution Simulator</p>
            <p className="card-sub-desc">
        ...
        <Card style={styles.cardWrap} elevation={4}>
          ...
          />
          <CardContent style={styles.cardDesc}>
            <p className="card-title">Vehicle Object Detection & Recognition</p>
            <p className="card-sub-desc">
        ...
        <Card style={styles.cardWrap} elevation={4}>
          ...
          />
          <CardContent style={styles.cardDesc}>
            <p className="card-title">Deep Q-Learning Agent</p>
            <p className="card-sub-desc">
        ...
        <Card style={styles.cardWrap} elevation={4}>
          ...
          />
          <CardContent style={styles.cardDesc}>
            <p className="card-title">Portable RFID Badge Access Lock</p>
            <p className="card-sub-desc">
