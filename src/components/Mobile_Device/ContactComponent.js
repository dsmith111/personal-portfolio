  ...
  return(
      <div className = "row skill-block"
        ...
        <div className = "col-12 mb-2" style={{marginTop:"20%"}}>
          <h1 className="display-3 section-header" style={{fontSize:"300%", fontWeight: "Bold"}}> Get in Touch</h1>

          <p><span className="fa fa-twitter-square fa-3x mb-5"><Link to="https://twitter.com/The_David_smith"
             style={{paddingLeft:10}}>Twitter
           </Link></span></p>
          <p><span className="fa fa-facebook-square fa-3x mb-5"><Link to="https://www.facebook.com/profile.php?id=100001273032145"
             style={{paddingLeft:10}}>Facebook
           </Link></span></p>
         <p><span className="fa fa-linkedin-square fa-3x mb-5"><Link to="https://www.linkedin.com/in/david-smith-1696a01a9/"
