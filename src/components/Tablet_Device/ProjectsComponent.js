    ...
    <div className="container-fluid skill-bgblock border-dark border-top border-2"
      ...
      <div className = "row skill-block"
        ...
        <div className="col-12"
          style={{
          paddingTop:60}}>
          <h1 className='display-3 mb-3' style={{fontSize:"290%"}}>Projects</h1>
          <Media list>

            <Media tag='li' className="mb-5">
              <Media body style={{fontSize:"90%"}}>
                <Media heading style={{fontSize:"155%", fontWeight:"bold"}}>
                ...
                to any door.
                <p><img src={`${process.env.PUBLIC_URL}/assets/mechdevice.jpg`} width="30%"
                  height="22%" alt="Test" className="border border-2 border-dark mt-2"/></p>
              </Media>
            </Media>
            <Media tag='li' className="mb-5">
              <Media body style={{fontSize:"90%"}}>
                ...
                <p><img src={`${process.env.PUBLIC_URL}/assets/snr.jpg`} width="30%"
                  height="22%" alt="Test" className="border border-2 border-dark mt-2"/></p>
              </Media>
            </Media>
            <Media tag='li' className="mb-5">
              <Media body style={{fontSize:"90%"}}>
                ...
                models.
                <p><img src={`${process.env.PUBLIC_URL}/assets/eco.png`} width="30%"
                  height="22%" alt="Test" className="border border-2 border-dark mt-2"/></p>
              </Media>
            </Media>
          </Media>
